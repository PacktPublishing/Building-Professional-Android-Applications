...
import com.packt.madev.database.AppDatabase;
...
public class PortfolioModule {
    ...
    public static abstract class PortfolioViewsModule {
        ...
        abstract StockPortfolioListViewActivity contributeStockPortfolioListViewActivity();

        @ContributesAndroidInjector
        abstract AddNewStockActivity contributeAddNewStockActivity();
    }
    ...
    public PortfolioRepository portfolioRepository(PortfolioRepository.RoomPortfolioRepository repository) {
        return new PortfolioRepository(repository);
    }
}